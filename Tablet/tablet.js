document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateScrollBar() {
    ...
    if (backToTopBtn) backToTopBtn.classList.toggle('visible', scrollTop > 420);
  }
  ...
  if (typewriterElement) {
    ...
    let roleIndex = 0; let charIndex = 0; let isDeleting = false; let typingDelay = 90;
    ...
    function typeRole() {
      ...
      if (!isDeleting && charIndex === currentRole.length) {
        ...
        isDeleting = false; roleIndex = (roleIndex + 1) % roles.length; typingDelay = 350;
      }
